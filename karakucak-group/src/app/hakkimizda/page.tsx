...
import { ChevronRight, ChevronDown, Building2, Award, Users, Globe, Lightbulb, Clock, BarChart, Target, Shield, ArrowRight, Phone } from "lucide-react";
...
export default function HakkimizdaPage() {
  return (
    <div className="min-h-screen">
      ...
      {/* İşbirliği CTA - Modern ve Kurumsal Tasarım */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center">
                <div className="lg:col-span-3">
                  ...
                  <h2 className="text-3xl md:text-4xl xl:text-5xl font-bold mb-6 text-white leading-tight">
                    Karakucak Group ile<br /> 
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-indigo-200">İşbirliği Yapalım</span>
                  </h2>
                  ...
                  <p className="text-lg xl:text-xl mb-8 text-blue-100/90 max-w-2xl leading-relaxed">
                    ...
                    Daha detaylı bilgi için bizimle iletişime geçin veya projelerimizi inceleyerek kalitemizi keşfedin.
                  </p>
                </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-4 mt-2 border-t border-white/10">
                        <div className="flex items-center justify-center">
                          ...
                          <span className="text-sm text-blue-200">+90 212 123 45 67</span>
                        </div>
                      </div>
                    </div>
                  </div>
